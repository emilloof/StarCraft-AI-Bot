...
class Move(Task):
    ...
    def on_start(self, py_unit: PyUnit) -> Status:
        ...
        #self.path = a_star(start_position, target_position, vertexes, self.agent)
        #print(self.path)
        #self.go(py_unit)
    ...
    def on_step(self, py_unit: PyUnit) -> Status:
        ...
        if py_unit.is_alive:
            ...
            if(self.frame_counter % 30 == 0):
                self.frame_counter = 0
                if self.agent.unit_collection.player_enemy_group_updated:
